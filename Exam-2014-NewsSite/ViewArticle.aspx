<%@ Page Title="Статья" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewArticle.aspx.cs" Inherits="NewsSite.ViewArticle" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:FormView runat="server" ID="FormViewArticle" ItemType="NewsSite.Models.Article" SelectMethod="FormViewArticle_GetItem">
        <ItemTemplate>
            ...
            <h2><%#: Item.Title %> <small>Категория: <%#: Item.Category.Name %></small></h2>
            <p><%#: Item.Content %></p>
            <p>
