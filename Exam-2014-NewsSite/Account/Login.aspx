<%@ Page Title="Войти" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="NewsSite.Account.Login" Async="true" %>
        ...
        <div class="col-md-8">
            <section id="loginForm">
                <div class="form-horizontal">
                    <h4>Используйте локальный аккаунт чтобы войти</h4>
                    <hr />
                ...
                <p>
                    <asp:HyperLink runat="server" ID="RegisterHyperLink" ViewStateMode="Disabled">Зарегистрироваться как новый пользователь</asp:HyperLink>
                </p>
                <p>
