<%@ Page Title="Редактировать категории" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Categories.aspx.cs" Inherits="NewsSite.Admin.Categories" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ListView runat="server" ID="ListViewCategories" ItemType="NewsSite.Models.Category" SelectMethod="ListViewCategories_GetData" DeleteMethod="ListViewCategories_DeleteItem" InsertMethod="ListViewCategories_InsertItem" UpdateMethod="ListViewCategories_UpdateItem" DataKeyNames="ID" InsertItemPosition="LastItem">
        <LayoutTemplate>
            <div class="row">
                <asp:LinkButton runat="server" CssClass="btn btn-default" ID="ButtonSortbyName" Text="Сортировать по имени" CommandName="Sort" CommandArgument="Name" />
            </div>
        ...
        <ItemTemplate>
            <div class="row">
                ...
                <asp:LinkButton runat="server" ID="ButtonEdit" Text="Редактировать" CssClass="btn btn-info" CommandName="Edit" CausesValidation="false" />
                <asp:LinkButton runat="server" ID="LinkButton1" Text="Удалить" CssClass="btn btn-danger" CommandName="Delete" CausesValidation="false" />
            </div>
        </ItemTemplate>
        <EditItemTemplate>
            <div class="row">
                ...
                <asp:LinkButton runat="server" ID="ButtonEdit" Text="Сохранить" CssClass="btn btn-success" CommandName="Update" ValidationGroup="EditCategory" CausesValidation="true" />
                <asp:LinkButton runat="server" ID="LinkButton1" Text="Отменить" CssClass="btn btn-danger" CommandName="Cancel" CausesValidation="false" />
            </div>
        </EditItemTemplate>
        <InsertItemTemplate>
            <div class="row">
                ...
                <asp:LinkButton runat="server" ID="ButtonEdit" Text="Сохранить" CssClass="btn btn-info" CommandName="Insert" CausesValidation="true" ValidationGroup="InsertCategory" />
                <asp:LinkButton runat="server" ID="ButtonCancel" Text="Отменить" CssClass="btn btn-danger" CommandName="Cancel" />
            </div>
        </InsertItemTemplate>
    </asp:ListView>
