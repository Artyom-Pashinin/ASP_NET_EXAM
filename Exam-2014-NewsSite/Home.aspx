<%@ Page Title="Новости" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="NewsSite.Home" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ListView runat="server" ID="ListViewPopularArticles" ItemType="NewsSite.Models.Article" SelectMethod="ListViewPopularArticles_GetData">
        <LayoutTemplate>
            <h2>Наиболее популярные статьи</h2>
